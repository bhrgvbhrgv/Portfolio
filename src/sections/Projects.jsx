        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
          <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
            ...
            <div className="flex justify-between items-center mt-7">
              ...
              <div className="px-4 py-2 rounded-full border border-black-300 bg-black-300/60 backdrop-blur-sm">
                <span className="text-sm font-semibold text-white-600 tracking-wide">{`Project ${selectedProjectIndex + 1} of ${projectCount}`}</span>
              </div>
